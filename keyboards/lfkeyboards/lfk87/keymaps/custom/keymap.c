...
const Layer_Info layer_info[] = {
    ...
    {0x00000004, 0xFFFFFFFC, {0x9A, 0x9A, 0xFF}}, // function layer - purple
    {0x00000008, 0xFFFFFFF8, {0xFF, 0x2A, 0x0F}}, // settings layer - red orange
...
[FUNC] = KEYMAP(
    ...
    KC_TR,   KC_TR, KC_TR, KC_TR, KC_TR, KC_TR, KC_TR, KC_TR, KC_TR, KC_TR, KC_TR, KC_TR,       KC_TR, \
    KC_TR,    KC_TR,  KC_TR,  KC_TR,  KC_TR, KC_TR, KC_TR, KC_TR, KC_TR, RGUI(KC_DOT), KC_TR, TG(SETTINGS),      RGUI(KC_UP), \
    KC_TR, TG(WINLOCK), KC_TR,              KC_TR,                   KC_TR, KC_TR, KC_TR, KC_TR,  RGUI(KC_LEFT), RGUI(KC_DOWN), RGUI(KC_RGHT)),
